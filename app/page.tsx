...
import { featuredProperties, standardProperties } from "@/data/mockProperties";
...
export default function Home() {
 ...
 <input
 className="block w-full pl-12 pr-4 py-4 rounded-xl border-none bg-white text-nordic-dark shadow-soft placeholder-nordic-muted/60 focus:outline-none focus:ring-2 focus:ring-mosque focus:bg-white transition-all text-lg"
 ...
 let hiddenClass = "";
 if (index === 4) hiddenClass = "hidden xl:flex"; // Central Studio
 if (index === 5) hiddenClass = "hidden lg:flex"; // Garden Villa
