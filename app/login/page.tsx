        ...
        <div className="bg-white rounded-2xl shadow-soft p-8 sm:p-10 border border-white/50 backdrop-blur-sm">
          <div className="space-y-4">
            <form action={signInWithGoogle}>
              <button className="group w-full flex items-center justify-center gap-3 bg-white border border-gray-100 rounded-lg p-3.5 text-nordic-dark font-medium transition-all duration-300 hover:shadow-soft-hover hover:-translate-y-0.5 relative overflow-hidden">
                ...
                <span className="relative z-10">{t('auth.google_continue')}</span>
              </button>
            </form>
            ...
            <form action={signInWithGithub}>
              <button className="group w-full flex items-center justify-center gap-3 bg-white border border-gray-100 rounded-lg p-3.5 text-nordic-dark font-medium transition-all duration-300 hover:shadow-soft-hover hover:-translate-y-0.5 relative overflow-hidden">
                ...
                <span className="relative z-10">{t('auth.github_continue')}</span>
              </button>
            </form>
          </div>
